...
- [Адреса Loopback-интерфейсов маршрутизаторов](#адреса-loopback-интерфейсов-маршрутизаторов)
...
### **Адреса Loopback-интерфейсов маршрутизаторов**:
...
|            | e0/0 (к SW4) |               |
|            | e0/0.10      | 10.12.4.1/24  |
|            | e0/0.70      | 10.12.4.7/24  |
|            | e0/1 (к SW5) |               |
|            | e0/1.10      | 10.12.5.1/24  |
|            | e0/1.70      | 10.12.5.7/24  |
...
|            | e0/0 (к SW5) |               |
|            | e0/0.10      | 10.13.5.1/24  |
|            | e0/0.70      | 10.13.5.7/24  |
|            | e0/1 (к SW4) |               |
|            | e0/1.10      | 10.13.4.1/24  |
|            | e0/1.70      | 10.13.4.7/24  |
...
|            | e0/1 (к R21 Ламас)  | 131.72.76.15/24  |
...
|            | e0/0 (к SW10) |                |
|            | e0/0.80       | 10.16.10.8/24  |
|            | e0/0.110      | 10.16.10.11/24 |
|            | e0/2 (к SW9)  |                |
|            | e0/2.80       | 10.16.9.8/24   |
|            | e0/2.110      | 10.16.9.11/24  |
...
|            | e0/0 (к SW9)  |                |
|            | e0/0.80       | 10.17.9.8/24   |
|            | e0/0.110      | 10.17.9.11/24  |
|            | e0/2 (к SW10) |                |
|            | e0/2.80       | 10.17.10.8/24  |
|            | e0/2.110      | 10.17.10.11/24 |
...
| R12        | Москва          | e0/2 (к R14)            | 10.14.12.2/30     |
|            |                 | e0/3 (к R15)            | 10.15.12.2/30     |
|            |                 | e0/0 (к SW4)            |                   |
|            |                 | e0/0.10 (VLAN 10)       | 10.12.4.1/24      |
|            |                 | e0/0.70 (VLAN 70)       | 10.12.4.7/24      |
|            |                 | e0/1 (к SW5)            |                   |
|            |                 | e0/1.10 (VLAN 10)       | 10.12.5.1/24      |
|            |                 | e0/1.70 (VLAN 70)       | 10.12.5.7/24      |
|            |                 | Loopback0               | 192.168.77.12/32  |
| R13        | Москва          | e0/2 (к R15)            | 10.15.13.2/30     |
|            |                 | e0/3 (к R14)            | 10.14.13.2/30     |
|            |                 | e0/0 (к SW5)            |                   |
|            |                 | e0/0.10                 | 10.13.5.1/24      |
|            |                 | e0/0.70                 | 10.13.5.7/24      |
...
| R16        | Санкт-Петербург | e0/1 (к R18)            | 10.18.16.2/30     |
|            |                 | e0/3 (к R32)            | 10.16.32.1/30     |
|            |                 | e0/0 (к SW10)           |                   |
|            |                 | e0/0.80 (VLAN 80)       | 10.16.10.8/24     |
|            |                 | e0/0.110 (VLAN 110)     | 10.16.10.11/24    |
|            |                 | e0/2 (к SW9)            |                   |
|            |                 | e0/2.80 (VLAN 80)       | 10.16.9.8/24      |
|            |                 | e0/2.110 (VLAN 110)     | 10.16.9.11/24     |
|            |                 | Loopback0               | 192.168.78.16/32  |
| R17        | Санкт-Петербург | e0/1 (к R18)            | 10.18.17.2/30     |
|            |                 | e0/0 (к SW9)            |                   |
|            |                 | e0/0.80 (VLAN 80)       | 10.17.9.8/24      |
|            |                 | e0/0.110 (VLAN 110)     | 10.17.9.11/24     |
|            |                 | e0/2 (к SW10)           |                   |
|            |                 | e0/2.80 (VLAN 80)       | 10.17.10.8/24     |
|            |                 | e0/2.110 (VLAN 110)     | 10.17.10.11/24    |
